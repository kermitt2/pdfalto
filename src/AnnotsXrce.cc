    ...
    for (int i = 0; i < objA.arrayGetLength(); ++i) {
        ...
        if (kid.isDict()) {
            ...
            if (dict->lookup("Subtype", &objSubtype)->isName()) {
                ...
                if (!strcmp(objSubtype.getName(), "Text") || !strcmp(objSubtype.getName(), "Highlight") ||
                    !strcmp(objSubtype.getName(), "Underline") || !strcmp(objSubtype.getName(), "FreeText") ||
                    !strcmp(objSubtype.getName(), "Link")) {
