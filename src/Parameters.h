...
public:
  ...
  /** Return a boolean which indicates if graphs processing should be skipped
   * entirely
   * @return <code>true</code> if the skipGraphs option is selected,
  ...
  /** Modify the boolean which indicates if graphs processing should be skipped
   * entirely
   * @param skip <code>true</code> if the skipGraphs option is selected,
   * <code>false</code> otherwise
   */
  void setSkipGraphs(GBool skip);
